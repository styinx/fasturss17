...
Finally the input has a number of message objects that travel through the system. We expect the input to look like Figure 1(!!!Instert figzure 1!!!)  				
...
Validate input\newline
Executable system\newline
With reliability patterns - circuit breaker\newline
